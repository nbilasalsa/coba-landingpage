      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-[#1a3a6b] inline-block relative">
            About
            <span className="absolute -bottom-4 left-0 w-full h-1.5 bg-[#043873]/50"></span>
          </h2>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/3 w-full flex flex-col items-center">
            <div className="w-full max-w-[300px] aspect-[4/5] relative mb-6">
              <img
                src="/images/siluet.png" 
                alt="Prof. Dr. Ir. Indrabayu"
                className="w-full h-full object-cover rounded-none border border-gray-100 shadow-sm"
              />
            </div>
            <div className="text-center">
              {/* text-base untuk nama agar tidak terlalu besar */}
              <h3 className="text-base font-bold text-[#1a3a6b] leading-tight mb-1">
          ...
          <div className="lg:w-2/3 w-full">
            <h1 className="text-3xl md:text-4xl font-bold text-[#1a3a6b] mb-8 leading-tight">
              Program Studi Teknik Informatika
            </h1>
            
            {/* text-sm untuk paragraf agar font lebih kecil sesuai request */}
            <div className="space-y-5 text-gray-700 text-sm md:text-[15px] leading-relaxed text-justify">
              <p>
